        ...
        <div class="display-ad" style="margin: 8px auto; display: block; text-align:center;">
			...
			<div class="sp-store-single-page row">
              ...
              <form action="" class="form-submit">
                ...
                <button type="submit" class="transmitv-cart ptransmitv-cart add-to-cart read-2 addItemBtn" <?php if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true){ echo '';} else { echo 'data-toggle="tooltip" title="Please login and come back"';} ?> >
                  Add to Cart
                </button>
              </form>
						</div>
