		...
		<div class="header-main col-lg-6 col-md-8 col-10">
			...
			<?php
				...
				if(isset($_POST['login']))
				{
					$mail = $_POST['email'];
					$psw = $_POST['password'];
					$sel = "select * from customer where email='$mail' and password='$psw'";
					...
					{	
						...
						echo '<script type="text/javascript">	
								location.replace("index_new.php");
							</script>';									//header("location:index.php"); is not working here.
					}
					else
					{
						echo '<div class="alert alert-danger alert-dismissible" id="myAlert">
								<button type="button" class="close">&times;</button>
								<strong>Email and Password is incorrect!! Try again</strong>
							</div>';
					}
				}
			?>
			...
			<p><kbd>New to Fonzone? <a href="signup.php">Create an account</a></kbd></p>
		</div> 
	</div>
</div>
